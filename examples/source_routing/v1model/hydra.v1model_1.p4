...
control initControl(inout hydra_header_t hydra_header,
  ...
  table tbl_lkp_cp_dict_expected_s1_dict
    {
    key = {
      hydra_metadata.expected_s1_dict_var0: exact;
    }
    actions = {
  ...
  table tbl_lkp_cp_dict_expected_s2_dict
    {
    key = {
      hydra_metadata.expected_s2_dict_var0: exact;
    }
    actions = {
  ...
  table tbl_lkp_cp_dict_expected_s3_dict
    {
    key = {
      hydra_metadata.expected_s3_dict_var0: exact;
    }
    actions = {
  ...
  apply
    ...
    hydra_metadata.expected_s3_dict_var0 = hdr.ipv4.dstAddr;
    ...
    hydra_metadata.expected_s2_dict_var0 = hdr.ipv4.dstAddr;
    ...
    hydra_header.expected_path_preamble.num_items_expected_path =
    hydra_header.expected_path_preamble.num_items_expected_path+1;
    hydra_metadata.expected_s1_dict_var0 = hdr.ipv4.dstAddr;
