...
control checkerControl(inout hydra_header_t hydra_header,
  ...
  apply
    ...
    hydra_header.left_loads_preamble.setInvalid();
    hydra_header.right_loads_preamble.setInvalid();
    hydra_header.left_loads[0].setInvalid();
    hydra_header.left_loads[1].setInvalid();
    hydra_header.left_loads[2].setInvalid();
    hydra_header.left_loads[3].setInvalid();
    hydra_header.right_loads[0].setInvalid();
    hydra_header.right_loads[1].setInvalid();
    hydra_header.right_loads[2].setInvalid();
    hydra_header.right_loads[3].setInvalid();
  }
}
