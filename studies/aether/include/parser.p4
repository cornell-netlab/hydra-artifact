...
//#include "tna/color_generated.p4"
//#include "tna/multitenancy_generated.p4"
// #include "tna/loops_generated.p4"
#include "tna/loadbalancing_generated.p4"
//#include "tna/vlanisolation_generated.p4"
//#include "tna/waypointing_generated.p4"
//#include "tna/ipv4routing_generated.p4"
//#include "tna/egressport_generated.p4"
//#include "tna/servicechains_generated.p4"
//#include "tna/sourceroute_generated.p4"
//#include "tna/appfiltering_generated.p4"
//#include "tna/statefulfirewall_generated.p4"
...
parser FabricIngressParser (packet_in  packet,
    ...
    state parse_vlan_tag {
        ...
        transition select(packet.lookahead<bit<16>>()) {
            ...
            default: parse_tele_or_eth_type;
        }
    }
    ...
    state parse_tele_or_eth_type {
        transition select(packet.lookahead<bit<16>>()) {
            ETHERTYPE_CHECKER: parse_telemetry;
            default: parse_eth_type;
        }
    }
    
    state parse_telemetry {
        hydra_parser.apply(packet, hdr.hydra_header, fabric_md.hydra_metadata);
...
#endif // WITH_INT
        /*
        if (hdr.hydra_header.variables.generate_report == 1) {
            mirror.emit(fabric_md.hydra_metadata.mirror_session_id);
        }
        */
    }
}
