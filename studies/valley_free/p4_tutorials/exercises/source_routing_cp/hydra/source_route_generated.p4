...
control initControl(in ipv4_t ipv4,
  ...
  table tb_debug {
    key = {
      ...
      hydra_header.expected_path[2].value: exact;
    }
    actions = {
      lkp_cp_dict_expected_s1_dict;
    }
    const entries = {
            (0,0,0): lkp_cp_dict_expected_s1_dict(0);
        }
    size = 2;
  }
  ...
  apply
    ...
    hydra_metadata.expected_s3_dict_var0 = ipv4.dstAddr; //167773188;
    ...
    hydra_header.expected_path_preamble.num_items_expected_path = 3;
    tb_debug.apply();
  }
}
